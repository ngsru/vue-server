...
var contentComponent = {
    ...
    template: [
        ...
        '<div id="overlapping">',
            '<comp class="outer" style="width: 36px;" v-bind:class="{\'outer-dyn\': true}" v-bind:style="{\'border-width\': \'36px\'}"></comp>',
        '<div>'
    ].join(''),
    data: function() {
        return {
    ...
    components: {
        comp: {
            ...
            template: '<div v-bind:class="{\'inner\': true}" v-bind:style="{\'height\': \'36px\'}" :disabled="state"></div>'
        }
    }
};
