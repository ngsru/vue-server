...
var objectUtils = {
    ...
    getNames: function getNames(object, isModern) {
        if (isModern) {
    ...
    getNamesLegacy: function getNamesLegacy(object) {
        var names = Object.keys(object);
        var objectProto = Object.getPrototypeOf(object);

        if (objectProto) {
            names = names.concat(this.getNamesLegacy(objectProto));
        }

        return names;
    },

    getNamesModern: function getNamesModern(object) {
...
exports.compileTemplate = function ($logger, template, logName) {
    ...
    if (template) {
        tplTypeof = typeof template === 'undefined' ? 'undefined' : _typeof(template);
...
function convertProps(props) {
    if (Array.isArray(props)) {
        ...
        return newProps;
    } else if ((typeof props === 'undefined' ? 'undefined' : _typeof(props)) === 'object' && props !== null) {
        return props;
    } else {
        return undefined;
    }
