...
exports.default = function (Vue) {
  ...
  Vue.prototype._initProps = function () {
    ...
    if (props && !el) {
      process.env.NODE_ENV !== 'production' && (0, _index3.warn)('Props will not be compiled if no `el` option is ' + 'provided at instantiation.', this);
    }
    // make sure to convert string selectors into element now
    el = options.el = (0, _index3.query)(el);
    this._propsUnlinkFn = el && el.nodeType === 1 && props
    // props must be linked in proper scope if inside v-for
    ? (0, _index.compileAndLinkProps)(this, el, props, this._scope) : null;
  };
  ...
  Vue.prototype._initData = function () {
    ...
    if (!(0, _index3.isPlainObject)(data)) {
      data = {};
      process.env.NODE_ENV !== 'production' && (0, _index3.warn)('data functions should return an object.', this);
    }
