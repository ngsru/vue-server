...
var _prop = require('../directives/internal/prop');
...
function compileProps(el, propOptions, vm) {
  ...
  while (i--) {
    ...
    if (!identRE.test(path)) {
      process.env.NODE_ENV !== 'production' && (0, _index2.warn)('Invalid prop key: "' + name + '". Prop keys ' + 'must be valid identifiers.', vm);
      continue;
    }
...
function getPropDefaultValue(vm, prop) {
  ...
  if ((0, _index2.isObject)(def)) {
    process.env.NODE_ENV !== 'production' && (0, _index2.warn)('Invalid default value for prop "' + prop.name + '": ' + 'Props with type Object/Array must use a factory function ' + 'to return the default value.', vm);
  }
...
function assertProp(prop, value, vm) {
  ...
  if (validator) {
    if (!validator(value)) {
      process.env.NODE_ENV !== 'production' && (0, _index2.warn)('Invalid prop: custom validator check failed for prop "' + prop.name + '".', vm);
      return false;
    }
  }
  return true;
