...
var _index3 = require('../directives/internal/index');

var _index4 = _interopRequireDefault(_index3);

var _compileProps = require('./compile-props');
...
function compileRoot(el, options, contextOptions) {
  ...
  if (el.nodeType !== 11) {
    ...
    if (names.length) {
      ...
      (0, _index5.warn)('Attribute' + (plural ? 's ' : ' ') + names.join(', ') + (plural ? ' are' : ' is') + ' ignored on component ' + '<' + options.el.tagName.toLowerCase() + '> because ' + 'the component is a fragment instance: ' + 'http://vuejs.org/guide/components.html#Fragment-Instance');
    }
  }
